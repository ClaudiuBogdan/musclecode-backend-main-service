...
describe('Binary Search Algorithm', () => {
  describe('Basic Functionality', () => {
    ...
    test('should find element at the beginning of the array', () => {
      expect(binarySearch([-1, 0, 2, 4, 6, 8], -1)).toBe(0);
    });

    test('should find element at the end of the array', () => {
  ...
  describe('Edge Cases', () => {
    ...
    test('should handle array with single element - found', () => {
      expect(binarySearch([1], 1)).toBe(0);
    });

    test('should handle array with single element - not found', () => {
      expect(binarySearch([1], 2)).toBe(-1);
    });

    test('should handle array with two elements - found first', () => {
      expect(binarySearch([1, 2], 1)).toBe(0);
    });

    test('should handle array with two elements - found second', () => {
  ...
  describe('Additional Coverage', () => {
    ...
    test('should find elements in left half', () => {
      expect(binarySearch([1, 2, 3, 4, 5], 2)).toBe(1);
    });

    test('should find elements in right half', () => {
