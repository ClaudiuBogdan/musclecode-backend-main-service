/**
 * Iterative implementation of the articulation points algorithm using an explicit stack to simulate DFS.
 *
 * @param graph - The undirected graph represented as an adjacency list.
 * @returns An array of articulation points.
 */
export function articulationPointsIterative(graph: number[][]): number[] {
